...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/parallel-analysis-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/biplots-1.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/biplots-2.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/biplots-3.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/biplots-4.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/bootstrap-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/models-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/deciles-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/unnamed-chunk-2-1.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{Assignment2_Group9_files/figure-latex/unnamed-chunk-3-1.pdf}}
...
## #   par(mfrow = c(6, 3),
## #       mar = c(3, 3, 3, 1),  
## #       oma = c(0, 0, 0, 0),     # outer margins a 0
## #       mgp = c(1.3, 0.4, 0))    # distancia de ejes/labels
## # 
## #   for (col in names(correlations)) {
## #     x <- X_corr[[col]]
## #     y <- y_corr
...
## #          xlab = col, ylab = "Next-day Max Temp (°C)",
## #          pch = 16, cex = 0.5, col = rgb(0,0,0.55,0.25))
## #     abline(lm(y ~ x), col = rgb(0.8,0,0,0.9), lwd = 1.4)
## #   }
## # })
## 
